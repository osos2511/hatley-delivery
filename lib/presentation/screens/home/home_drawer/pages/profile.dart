    ...
    return MultiBlocProvider(
      ...
      child: BlocBuilder<ProfileCubit, ProfileState>(
        builder: (context, profileState) {
          ...
          if (selectedGovernorateId == null && profile.governorateId != null) {
            // Use profile.governorateId
            selectedGovernorateId =
                profile.governorateId; // Use profile.governorateId
            // إذا كانت هناك محافظة حالية، قم بجلب المناطق المرتبطة بها لتهيئة dropdown المناطق
            if (profile.governorateId != null) {
              // Use profile.governorateId
              ...
              WidgetsBinding.instance.addPostFrameCallback((_) {
                ...
                context.read<ZoneCubit>().fetchZones(
                  govName: profile.governorateId.toString(),
                ); // Corrected
              });
            }
          }
          if (selectedZoneId == null && profile.zoneId != null) {
            // Use profile.zoneId
                      ...
                      child: Column(
                        children: [
                          Stack(
                            ...
                            children: [
                              ProfileImgAvatar(
                                imageUrl: profile.photo?.isNotEmpty == true
                                    ? profile.photo!
                                    : 'assets/person.png',
                                size: 120,
                              ),
                          ...
                          ProfileInfoTile(
                            label: 'governorate_name',
                            value: profile.governorateName ?? '',
                          ),
                          ProfileInfoTile(
                            label: 'zone_name',
                            value: profile.zoneName ?? '',
                          ),
                          SizedBox(height: 20.h),
                          statsWidget,
                              ...
                              showDialog(
                                ...
                                builder: (dialogContext) => MultiBlocProvider(
                                  providers: [
                                    ...
                                    BlocProvider.value(
                                      value: context.read<GovernorateCubit>(),
                                    ),
                                    BlocProvider.value(
                                      value: context.read<ZoneCubit>(),
                                    ),
                                  ],
                                  child: EditProfileDialog(
                                    ...
                                    currentGovern: profile
                                        .governorateId, // Corrected to currentGovernId: profile.governorateId
                                    currentZone: profile
                                        .zoneId, // Corrected to currentZoneId: profile.zoneId
                                    onSave:
                                        (
                                          name,
                                          email,
